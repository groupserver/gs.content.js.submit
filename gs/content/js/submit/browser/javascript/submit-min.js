"use strict";jQuery.noConflict();function GSDisableSubmit(){var b='<button class="processing btn" disabled="disabled">Processing\u2026</button>';
...
}}}}jQuery(window).load(function(){var a=null;a=GSDisableSubmit();a.init()});